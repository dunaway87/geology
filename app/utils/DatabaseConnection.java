...
public class DatabaseConnection {
	...
	public static Connection getConnection() throws SQLException{
		...
		Connection conn = DriverManager.getConnection("jdbc:postgresql://geoblaster.info:5432/geology?user=dunawayjenckes&password=MacsEdgar2155");
	...
	public static void main(String[] args) throws SQLException, IOException{
		...
		FileReader fr = new FileReader(new File("/data/layers.csv"));
		BufferedReader br = new BufferedReader(fr);
		String line = "";
		while((line = br.readLine()) != null ){
			//String[] values = line.split(",");
			String sql ="INSERT into folders.layer values("+line.replace("\"", "'")+")";
